...
void Leer(){
	...
	cout<<"ID"<<"|"<<"Codigo"<<"|"<<"   Nombres  "<<"|"<<"   Apellidos   "<<"|"<<" nota1"<<"|"<<" nota2"<<"|"<<" nota3"<<"|"<<" nota4"<<"|"<<" promedio"<<"|"<<" Aprobo"<<endl;
	do{
		cout<<id<<"|"<<estudiante.codigo<<"|"<<estudiante.nombres<<"|"<<estudiante.apellidos<<"|"<<estudiante.nota1<<"|"<<estudiante.nota2<<"|"<<estudiante.nota3<<"|"<<estudiante.nota4<<"|"<<estudiante.promedio<<endl;
		fread(&estudiante,sizeof(Estudiante),1,archivo);
		id+=1;
